...
const CreatePost = () => {
    ...
    const generateImg = async () => {
        if (form.prompt) {
            ...
            alert('Please Enter a Prompt and generate a new image');
        }
    };
        ...
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
                    Create a very creative an imaginative image that will be
                    generated by Delta-AI usinig your prompt. And share them
                    with the comunity
                </p>
            </div>
            <form action="" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    <FormField
                        ...
                        type="text"
                        name="prompt"
                        placeholder="a bowl of soup that looks like a monster"
                        value={form.prompt}
                        handleChange={handleChange}
                        isSurpriseMe
                ...
                <div className="mt-10">
                    <p className="mt-2 text-[#666e75] text-[14px]">
                        If you are satisfied with your image, Share it with the
                        comunity
                    </p>
                    <button
                        type="submit"
